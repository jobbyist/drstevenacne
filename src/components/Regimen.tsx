...
const STEPS = [
  {
    n: "01",
    title: "Cleanse",
    body: "Acne Control Cleanser sweeps away oil, sweat, and impurities — twice daily.",
    time: "AM + PM",
  },
  {
    n: "02",
    title: "Treat",
    body: "Acne Treatment Gel targets active breakouts and calms redness on contact.",
    time: "PM",
  },
  {
    n: "03",
    title: "Hydrate",
    body: "Acne Control Moisturizer restores moisture without clogging pores.",
    time: "AM + PM",
  },
  {
    n: "04",
    title: "Protect",
    body: "Acne Defence SPF 50+ shields skin from UV and post-acne dark marks.",
    time: "AM",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          <div className="lg:col-span-5">
            ...
            <p className="mt-5 text-muted-foreground text-base md:text-lg max-w-md">
              Acne care doesn't need to be complicated. Four products, used consistently — that's
              the system Dr Steven's clinic has refined over twenty years.
            </p>
            <div className="mt-8 inline-flex items-center gap-3 rounded-full bg-background border border-border pl-2 pr-5 py-2">
              <span className="h-7 w-7 rounded-full bg-clinical text-clinical-foreground text-xs font-semibold inline-flex items-center justify-center">
                8w
              </span>
              <span className="text-[13px] text-primary/80">
                Visible improvement in 4–8 weeks of consistent use.
              </span>
            </div>
          </div>
          <div className="lg:col-span-7">
            <div className="relative rounded-2xl overflow-hidden bg-background shadow-soft">
              <img
                src={productRange}
                alt="The Dr Steven Acne four-step regimen"
