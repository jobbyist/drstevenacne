      ...
      <div className="container-px mx-auto max-w-[1400px] grid grid-cols-1 lg:grid-cols-12 gap-12 items-center relative">
        <div className="lg:col-span-7">
          ...
          <p className="mt-5 text-base md:text-lg text-primary-foreground/75 max-w-xl leading-relaxed">
            Chat through your skin profile, lifestyle, and current routine. Steven AI builds a
            custom regimen — products, application order, lifestyle adjustments — drawing on Dr
            Steven's two decades of clinical practice.
          </p>
          <div className="mt-8 flex flex-wrap gap-3">
            ...
            <a
              href="#shop"
              className="inline-flex items-center gap-2 h-12 px-6 rounded-full border border-primary-foreground/25 text-sm font-semibold tracking-wide hover:bg-primary-foreground/10 transition"
            >
              Browse products
            </a>
          </div>
          ...
          <div className="mt-10 grid grid-cols-2 sm:grid-cols-4 gap-6 max-w-xl text-primary-foreground/85">
            {["Skin profile", "Lifestyle audit", "Custom routine", "Ingredient swaps"].map((t) => (
              <div key={t} className="text-[12px] uppercase tracking-[0.16em] font-medium">
                {t}
              </div>
            ))}
          </div>
